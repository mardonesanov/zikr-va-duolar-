...
<div class="container">
    ...
    <div class="search-container">
        <input type="text" id="search" placeholder="Zikr nomini qidiring..." onkeyup="filterDuolar()">
    </div>
    <!-- Admin uchun Yangi Zikr Qo'shish tugmasi -->
    <c:if test="${user != null && user.role == 'admin'}">
        <a href="/masjid?action=add" class="add-zikr-btn">Yangi Zikr Qo'shish</a>
    </c:if>
    <!-- Zikrlar ro'yxati -->
    <c:forEach var="zikr" items="${zikrList}">
        <div class="dua-item" onclick="toggleZikrContent(this)">
            <h3 class="dua-title">${zikr.name}</h3>
            <div class="dua-content">
                ...
                <c:if test="${user != null && user.role == 'admin'}">
                    <div class="actions">
                        <a href="/masjid?action=edit&id=${zikr.id}">Yangilash</a>
