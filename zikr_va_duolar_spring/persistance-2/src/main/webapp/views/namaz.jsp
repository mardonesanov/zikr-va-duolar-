            ...
            fetch(`/saveNamazDua`, {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        button.textContent = isSaved ? 'Saqlanganlarga qoshish' : 'Saqlanganlardan ochirish';
                    } else {
...
<div class="container">
    ...
    <c:if test="${user != null && user.role == 'admin'}">
        <a href="/views/add_namaz.html" class="add-dua-btn">Yangi Duo Qo'shish</a>
    </c:if>
    <!-- Duolar ro'yxati -->
    <c:forEach var="dua" items="${duaList}">
        <div class="dua-item" onclick="toggleDuaContent(this)">
            ...
            <div class="dua-content">
                ...
                <c:if test="${user != null && user.role == 'admin'}">
                    <div class="actions">
                        <a href="/namaz?action=edit&id=${dua.id}">Yangilash</a>
            ...
            <button class="save-btn"
                    data-dua-id="${dua.id}"
                    data-saved="${savedDuolar.contains(dua.id) ? 'true' : 'false'}"
                    onclick="event.stopPropagation(); toggleSave(this);">
                    ${savedDuolar.contains(dua.id) ? 'Saqlanganlardan ochirish' : 'Saqlanganlarga qoshish'}
            </button>
        </div>
    </c:forEach>
