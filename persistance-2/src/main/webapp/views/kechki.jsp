...
<div class="container">
    ...
    <c:if test="${user != null && user.role == 'admin'}">
        <a href="/views/add_kechki.html" class="btn btn-success mt-3"><i class="fas fa-plus-circle"></i> Yangi Zikr Qo'shish</a>
    </c:if>
    <c:forEach var="zikr" items="${zikrs}">
        <div class="zikr-item" onclick="toggleZikrContent(this)">
            <h3 class="zikr-title"><i class="fas fa-moon"></i> ${zikr.name}</h3>
