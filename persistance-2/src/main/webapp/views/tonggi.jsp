...
<head>
    ...
    <title>Tonggi Zikrlar Ro'yxati</title>
    <style>
        body {
    ...
    <c:forEach var="zikr" items="${zikrList}">
        <div class="zikr-item" onclick="toggleZikrContent(this)">
            ...
            <div class="zikr-content">
                ...
                <c:if test="${user != null && user.role == 'admin'}">
                    <div class="actions">
                        <a href="/tonggi?action=edit&id=${zikr.id}"><i class="fas fa-edit"></i> Yangilash</a>
